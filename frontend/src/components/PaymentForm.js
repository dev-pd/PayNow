...
//             Card Details
//           </label>
//           <CardElement className="p-2 bg-gray-100 border rounded" />
//         </div>
//         <button
//           type="submit"
//           disabled={!stripe}
//           className="w-full bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-700 focus:outline-none focus:shadow-outline transition-colors duration-150 ease-in-out">
//           Pay Now
//         </button>
//       </form>
//     </div>
